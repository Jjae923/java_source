...
public class LinkedListEx2 {
	public static void main(String[] args) {
		...
		System.out.println("=== 순차적으로 추가하기 ===");		// ArrayList > LinkedList
		System.out.println("ArrayList : "+add1(arrayList));
		System.out.println("LinkedList : "+add1(linkedList));

		System.out.println();
		
		System.out.println("=== 중간에 추가하기 ===");			// ArrayList < LinkedList
		...
		System.out.println("=== 중간에서 삭제하기 ===");			// ArrayList < LinkedList
		System.out.println("ArrayList : "+remove2(arrayList));
		System.out.println("LinkedList : "+remove2(linkedList));
		
		System.out.println();

		System.out.println("=== 순차적으로 삭제하기 ==="); 		// ArrayList > LinkedList
