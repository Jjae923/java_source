...
public class MyShop implements Ishop { // 배열
	...
	private Product[] select = new Product[10]; // 제품리스트에서 구매상품 담는 변수 배열
	...
	public void genProduct() {
		...
		products[0] = new CellPhone("갤럭시20", 1500000, "SKT");
		products[1] = new SmartTV("삼성 3D SmartTV", 2000000, "1260x960");
		products[2] = new CellPhone("아이폰11 pro", 1800000, "KT");
		products[3] = new CellPhone("아이폰 SE2", 900000, "LGU");
		products[4] = new SmartTV("LG 3D SmartTV", 1900000, "1920x960");
	}
...
//		}
	public void checkOut() {
		...
		System.out.println("==============================");
		System.out.println("결제 방법 : "+users[costomer].getPayType());
